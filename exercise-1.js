...
buttonStyle = (h,w,text, element) => { //Le pone estilo a los botones que se generan
...
buttonStyle('80px','80px',"Borrar ultimo", button);
document.body.appendChild(button);
button.addEventListener('click', function (event){  
    (lastUl[pos].lastChild) ? //Comprobar que siga existiendo el ultimo elemento
        lastUl[pos].removeChild(lastUl[pos].lastChild)
        : console.log('Error, ya se han borrado todos los elemetos');   
})
